...
int main(int argc, char *argv[]) {
    ...
    if (FLAGS_i == "") {
        ...
        cout << "Usage: " << argv[0]
             << " -i /input/file/path.png (optional)-o /output/file/path.txt (optional)-dt distance_threshold (optional)-lt length_threshold"
             << endl;
        return 0;
    }

    LineDetector ld = LineDetector(FLAGS_dt, FLAGS_lt);
